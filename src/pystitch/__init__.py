...
def read(file, settings=None, pattern=None):
    ...
    return EmbPattern.read_embroidery(reader, file, settings, pattern)
...
def write(pattern, file, settings=None):
    ...
    EmbPattern.write_embroidery(writer, pattern, file, settings)
